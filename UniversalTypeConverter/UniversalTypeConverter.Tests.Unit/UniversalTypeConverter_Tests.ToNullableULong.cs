...
namespace TB.ComponentModel.Tests.Unit {
    ...
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableULong_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            UniversalTypeConverter.ConvertTo<ulong?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableULong_From_String_WithValueAbc_ShouldThrowInvalidOperationException() {
            string value = "abc";

...
namespace TB.ComponentModel.Tests.Unit {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_ULong_From_Bool_WithValueFalse_ShouldReturn_0() {
            ...
            UniversalTypeConverter.ConvertTo<ulong>(value).Should().Be(expectedValue);
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableBool_WithValueNull_ShouldThrowInvalidOperationException() {
            bool? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableByte_WithValueNull_ShouldThrowInvalidOperationException() {
            byte? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableChar_WithValueNull_ShouldThrowInvalidOperationException() {
            char? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableDateTime_WithValueNull_ShouldThrowInvalidOperationException() {
            DateTime? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableDecimal_WithValueNull_ShouldThrowInvalidOperationException() {
            decimal? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableDouble_WithValueNull_ShouldThrowInvalidOperationException() {
            double? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableFloat_WithValueNull_ShouldThrowInvalidOperationException() {
            float? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableInt_WithValueNull_ShouldThrowInvalidOperationException() {
            int? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableLong_WithValueNull_ShouldThrowInvalidOperationException() {
            long? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_Object_WithValueNull_ShouldThrowInvalidOperationException() {
            object value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableSByte_WithValueNull_ShouldThrowInvalidOperationException() {
            sbyte? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableShort_WithValueNull_ShouldThrowInvalidOperationException() {
            short? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_String_WithValueAbc_ShouldThrowInvalidOperationException() {
            string value = "abc";
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_String_WithValueNull_ShouldThrowInvalidOperationException() {
            string value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableUInt_WithValueNull_ShouldThrowInvalidOperationException() {
            uint? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableULong_WithValueNull_ShouldThrowInvalidOperationException() {
            ulong? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_ULong_From_NullableUShort_WithValueNull_ShouldThrowInvalidOperationException() {
            ushort? value = null;
            Action action = () => UniversalTypeConverter.ConvertTo<ulong>(value);
            action.ShouldThrow<InvalidOperationException>();
        }

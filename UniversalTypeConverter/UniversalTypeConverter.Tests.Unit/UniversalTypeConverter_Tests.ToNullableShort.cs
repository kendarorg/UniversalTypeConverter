...
namespace TB.ComponentModel.Tests.Unit {
    ...
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableShort_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            UniversalTypeConverter.ConvertTo<short?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableShort_From_String_WithValueAbc_ShouldThrowInvalidOperationException() {
            string value = "abc";

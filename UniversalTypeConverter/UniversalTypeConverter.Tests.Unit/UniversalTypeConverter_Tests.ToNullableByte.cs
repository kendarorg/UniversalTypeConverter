...
namespace TB.ComponentModel.Tests.Unit {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableByte_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            UniversalTypeConverter.ConvertTo<byte?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableByte_From_String_WithValueAbc_ShouldThrowInvalidOperationException() {
            string value = "abc";

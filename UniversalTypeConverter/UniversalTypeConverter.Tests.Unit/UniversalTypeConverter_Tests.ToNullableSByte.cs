...
namespace TB.ComponentModel.Tests.Unit {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableSByte_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            UniversalTypeConverter.ConvertTo<sbyte?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableSByte_From_Char_WithValue255_ShouldThrowInvalidOperationException() {
            char value = (char)255;
        ...
        [TestMethod]
        public void ConvertTo_NullableSByte_From_String_WithValueAbc_ShouldThrowInvalidOperationException() {
            string value = "abc";
            Action action = () => UniversalTypeConverter.ConvertTo<sbyte?>(value);
            action.ShouldThrow<InvalidOperationException>();
        }
